  ...
  return (
    <div class="sidebar_wrapper">
      <div class="navbar__menu_icons">
        <picture>
          <img class="navbar__logo_image" src="../../public/images/logo.png" alt="site logo" />
          <img class="navbar__logo_image_small" src="../../public/images/instagram-pic.png" alt="site logo small" />
        </picture>
